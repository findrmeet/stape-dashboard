      ...
      <div className="mt-14 grid grid-cols-1 gap-16 lg:grid-cols-2">
        ...
        <div>
          ...
          <div className="space-y-5">
            <Checkbox label="Share all current and new" checked />
            ...
            <Checkbox label="Signals Gateways" />
            <Checkbox label="Growth Academy" checked />
            <Checkbox label="sGTM" />
            <Checkbox label="Test" checked />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mb-6 h-px w-full bg-[#1C2230]" />
          <Checkbox label="Allow view and edit billing information" checked />
        </div>
      </div>
