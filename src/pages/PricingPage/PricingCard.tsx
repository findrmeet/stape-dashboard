    ...
    <>
      <div className={`relative ${highlighted ? "card-wrapper" : ""}`}>
        ...
        >
          <div>
            ...
            <button
              className={`mt-6 w-full cursor-pointer rounded-lg py-2.5 text-sm font-medium transition ${
                highlighted
                  ? "bg-white text-black"
                  : "border border-[#26272F] bg-[#0E0F14] text-white"
              }`}
            ...
            <div className="mt-8">
              <h4 className="mb-4 text-sm font-medium">Included Features:</h4>
      ...
      <PrimaryModal active={active} setActive={setActive}>
        <div className="relative w-full max-w-xl rounded-2xl bg-linear-to-b from-[#0E0F14] to-[#07080C] text-white shadow-2xl">
          {/* Header */}
          <div className="flex items-center justify-between border-b border-[#26272F] pb-4">
          ...
          {/* Pay Button */}
          <button className="mt-6 w-full cursor-pointer rounded-lg bg-[#EEF1FF] py-3 text-sm font-medium text-black transition hover:bg-white">
            Pay Now
          </button>
          ...
          <div className="mt-6 border-t border-[#26272F] pt-4">
            ...
            <p className="mt-2 text-xs leading-relaxed text-neutral-500">
              ...
              <span className="text-white underline">non-refundable</span>. You can{" "}
              <span className="text-white underline">change or cancel your plan</span> at any time
            </p>
          </div>
          ...
          <div className="mt-6 border-t border-[#26272F] pt-4">
            ...
            <p className="mt-2 text-xs leading-relaxed text-neutral-500">
              Proceeding by selecting the button above will enroll you in a recurring subscription
              plan. Signaly will charge your payment method this amount yearly plus applicable
              taxes, minus any discounts or credits.
            </p>
          </div>
